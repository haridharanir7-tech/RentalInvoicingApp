    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={['Admin']} />}>
            ...
            <Route
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    moduleName="Rental Rates"
                    teammateName="Haridharani"
                    description="Rental rate matrix, periodic revisions, and auto-calculation rules."
                  />
                </AppLayout>
              }
            />
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    ...
                    teammateName="Haridharani"
                    description="Automated monthly invoice calculation engine, batch bill generation, and additional charges."
                  />
                </AppLayout>
              }
            />

            {/* 7. Invoices (Haridharani / InvoiceRegister) */}
            <Route
              path="/admin/invoices"
              element={
                <AppLayout>
            ...
            <Route
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    moduleName="GST Monthly Report"
                    teammateName="Haridharani"
                    description="GSTR-1 tax return preparation, CGST/SGST/IGST breakdown, and compliance export."
                  />
                </AppLayout>
              }
            />
          ...
          <Route element={<ProtectedRoute allowedRoles={['Landlord']} />}>
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    moduleName="Generate Invoice"
                    teammateName="Haridharani"
                    description="Generate customized rental invoices for tenants residing in your properties."
                  />
                </AppLayout>
              }
            />
            ...
            <Route
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    moduleName="GST Report"
                    teammateName="Haridharani"
                    description="GST summary for all rent and charges collected under your GSTIN."
                  />
                </AppLayout>
              }
            />
          ...
          {/* Legacy / Backward Compatibility Routes for Priya module */}
          <Route element={<ProtectedRoute />}>
            ...
            <Route
              ...
              element={
                <AppLayout>
                  <ModulePlaceholder
                    moduleName="Haridharani - Invoicing & Rates"
                    teammateName="Haridharani"
                    description="Rental Rate Configuration, Auto-Calculation, and GST Monthly Reporting."
                  />
                </AppLayout>
              }
            />
